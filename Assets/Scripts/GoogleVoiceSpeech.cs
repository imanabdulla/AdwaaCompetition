...
public class GoogleVoiceSpeech : MonoBehaviour
{
    ...
    public LangaugeCode langaugeCode;
    ...
    private bool micConnected = false;
		...
		public string apiKey = "AIzaSyBCRpVxNVLcyugpc9_DhzkplChLdo20FJ0";
	...
	void Start () {
        ...
        switch (langaugeCode)
        {
            case LangaugeCode.enUS:
                langCodeString = "\"en-US\"";
                break;
            case LangaugeCode.arEG:
                langCodeString = "\"ar-EG\"";
                break;
            default:
                break;
        }
            ...
            else //Recording is in progress
            {
                ...
                if (GUI.Button(new Rect(Screen.width / 2 - 100, Screen.height / 2 - 25, 200, 50), "Stop and Play!"))
                {
                    ...
                    if (jsonresponse != null)
                    {
                        ...
                        Debug.Log("jsonResults: " + resultString);


                        string transcript = jsonResults["alternatives"][0]["transcript"].ToString();

                        Debug.Log("transcript string: " + transcript);
                        textMesh.text = transcript;
